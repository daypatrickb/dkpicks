...
class PicksControllerTest < ActionController::TestCase
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post :create, pick: { diff: @pick.diff, game_id: @pick.game_id, result: @pick.result, team_id: @pick.team_id }
    end
  ...
  test "should update pick" do
    patch :update, id: @pick, pick: { diff: @pick.diff, game_id: @pick.game_id, result: @pick.result, team_id: @pick.team_id }
    assert_redirected_to pick_path(assigns(:pick))
  end
